...
def  probar_modelos_grid(X_train, y_train, X_test, y_test,nombre_modelo="modelo_xx"):
  ...
  Modelos por defecto: 
    ...
    - Random Forest
    - XGBoost
  Los modelos tienen los hiperparámetros definidos en el último grid search (scoring = f1-score).
  ---
  Métricas porq defecto:
...
def  probar_modelos_grid2(X_train, y_train, X_test, y_test,nombre_modelo="modelo_xx"):
  '''
  Función que prueba varios modelos de clasificación con nuestros datos, entrenarlos y predecir resultados
  ---
  Modelos por defecto: 
    ...
    - Random Forest
    - XGBoost
  Los modelos tienen los hiperparámetros definidos en el último grid search (scoring = precision).
  ---
  Métricas porq defecto:
